...
def x_laea(ge: float = -2e6, le: float = 2e6) -> Any:
    return pa.Field(dims=("x_laea",), nullable=False, ge=ge, le=le)


def y_laea(ge: float = -2e6, le: float = 2e6) -> Any:
    return pa.Field(dims=("y_laea",), nullable=False, ge=ge, le=le)
